...
UI = {
    ...
    "nav_ra": T("📝 風險評估報告生成器", "📝 Risk Assessment Generator"),
    "ra_intro": T("輸入工程/工序資料,自動生成**風險評估報告**(危害識別→風險評估→控制措施)。支援於新視窗開啟完整功能,或直接在下方內嵌使用。",
                  "Enter your project/task details to auto-generate a **risk assessment report** (hazard ID → risk evaluation → controls). Open in a new window for the full experience, or use the embedded version below."),
    "ra_btn": T("📝 開啟風險評估報告生成器(新視窗)", "📝 Open Risk Assessment Generator (new window)"),
    "ra_note": T("提示:內嵌畫面如要求登入,表示該工具目前為 Streamlit 私人應用——請按上方按鈕於新視窗登入使用;或由網主在 Streamlit Cloud 將該 app 改為 Public,訪客即可直接使用(網主可於後台更改此工具網址)。",
                 "Note: if the embedded view asks you to log in, the tool is currently a private Streamlit app — use the button above; the owner can also switch it to Public in Streamlit Cloud or change the URL in Admin."),
            ...
            "blocks": [
                ("table",
                 ...
                 T([
                     ...
                     ["香港政府新聞網", "頭條、法律及治安、施政、新聞速遞(即時)", "RSS", "[news.gov.hk](https://www.news.gov.hk)"],
                     ...
                     ["美國 **OSHA**", "官方新聞發布", "官方RSS", "[osha.gov/news](https://www.osha.gov/news/newsreleases.xml)"],
                     ["美國 **OSHA QuickTakes**", "OSHA雙週職安通訊", "官方RSS", "[osha.gov/quicktakes](https://www.osha.gov/quicktakes)"],
                     ["英國 **HSE**", "英國職安新聞(新聞中心)", "RSS", "[hse.gov.uk](https://www.hse.gov.uk)"],
                     ["美國 **Safety+Health 雜誌**", "美國及國際職安資訊、OSHA動態(NSC刊物)", "RSS", "[safetyandhealthmagazine.com](https://www.safetyandhealthmagazine.com)"],
                     ["美國 **OHS Online**", "美國職安工業衞生新聞", "網頁抓取", "[ohsonline.com](https://ohsonline.com)"],
                     ["英國 **IOSH**(職業安全健康學會)", "國際最大職安專業機構的新聞及研究", "靜態連結(官網JS動態,暫未能自動抓取)", "[iosh.org](https://iosh.org/news)"],
                     ["**IIRSM**(國際風險與安全管理學會)", "風險管理專業資訊", "靜態連結(官網JS動態,暫未能自動抓取)", "[iirsm.org](https://www.iirsm.org/news)"],
                     ...
                     ["HK Gov News", "Top stories, law and order, administration, news ticker", "RSS", "[news.gov.hk](https://www.news.gov.hk)"],
                     ...
                     ["US **OSHA**", "Official news releases", "Official RSS", "[osha.gov/news](https://www.osha.gov/news/newsreleases.xml)"],
                     ["US **OSHA QuickTakes**", "OSHA biweekly e-newsletter", "Official RSS", "[osha.gov/quicktakes](https://www.osha.gov/quicktakes)"],
                     ["UK **HSE**", "UK OSH news (media centre)", "RSS", "[hse.gov.uk](https://www.hse.gov.uk)"],
                     ["US **Safety+Health magazine**", "US & international OSH news, OSHA updates (NSC publication)", "RSS", "[safetyandhealthmagazine.com](https://www.safetyandhealthmagazine.com)"],
                     ["US **OHS Online**", "US occupational health & safety news", "HTML scrape", "[ohsonline.com](https://ohsonline.com)"],
                     ["UK **IOSH**", "World's largest OSH professional body — news & research", "Static link (JS site, not auto-fetched)", "[iosh.org](https://iosh.org/news)"],
                     ["**IIRSM**", "International Institute of Risk & Safety Management news", "Static link (JS site, not auto-fetched)", "[iirsm.org](https://www.iirsm.org/news)"],
