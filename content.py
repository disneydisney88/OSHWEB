...
UI = {
    ...
    "auto_note": T("新聞及統計每小時自動更新一次(快取);亦可按「立即更新」。",
                   "News & statistics auto-refresh hourly (cached); click “Refresh now” to force."),
            ...
            "blocks": [
                ("table",
                 ...
                 T([
                     ...
                     ["第59U章《工廠及工業經營(安全管理)規例》", "指定企業(如大型承建商)須建立14項元素的安全管理制度。", "[勞工處法例一覽](https://www.labour.gov.hk/tc/legislat/contentB3.htm)"],
                     ...
                     ["Cap. 59U FIU (Safety Management) Regulation", "Specified undertakings (e.g. large contractors) must implement a 14-element safety management system.", "[LD list](https://www.labour.gov.hk/tc/legislat/contentB3.htm)"],
...
SECTIONS["cop"] = {
    ...
    "intro": T(
        "工作守則由**勞工處處長**根據職安法例發出,提供安全工作方法的實務指引。不遵守守則**本身並非違法**,但在法律程序中可作為證據,用以證明或否定違反安全法例。",
        "COPs are issued by the **Commissioner for Labour** under OSH law as practical guidance. Non-compliance is **not itself an offence**, but may be used in legal proceedings as evidence of breaching safety law."),
    "panels": [
        {
            "h": T("常用工作守則例子", "Common codes of practice"),
            "blocks": [
                ("table",
                 T(["工作守則", "主題"], ["Code of Practice", "Topic"]),
                 T([
                     ["安全管理工作守則", "第59U章安全管理制度的建立、推行及審核(14項元素)。"],
                     ["密閉空間工作的安全與健康", "評估、許可證制度、氣體監測、監視人([官方PDF](https://www.labour.gov.hk/tc/public/pdf/os/B/spacec.pdf))。"],
                     ["金屬棚架工作安全守則", "金屬棚架的搭建、改動及拆卸([官方PDF](https://www.labour.gov.hk/tc/public/pdf/os/B/MS.pdf))。"],
                     ["氣體焊接及火焰切割工作的安全與健康", "焊接切割防火防爆、氣樽處理。"],
                     ["手工電弧焊接工作的安全與健康", "電焊安全、觸電防護、眼部保護。"],
                     ["工業潛水的工作安全與健康", "潛水作業計劃、潛水主任及潛水員要求。"],
                     ["惡劣天氣及「極端情況」下工作守則", "8號及以上颱風信號、黑雨及極端情況下的工作安排。"],
                 ], [
                     ["Safety Management", "14-element SMS under Cap. 59U — implementation and audits."],
                     ["Safety & Health in Confined Spaces", "Assessment, permit-to-work, gas monitoring, standby person ([official PDF](https://www.labour.gov.hk/tc/public/pdf/os/B/spacec.pdf))."],
                     ["Metal Scaffolding Safety", "Erection, alteration and dismantling ([official PDF](https://www.labour.gov.hk/tc/public/pdf/os/B/MS.pdf))."],
                     ["Gas Welding & Flame Cutting", "Fire/explosion prevention, cylinder handling."],
                     ["Manual Electric Arc Welding", "Electrical and eye protection."],
                     ["Industrial Diving", "Diving operations, supervisor and diver requirements."],
                     ["Work in Adverse Weather & 'Extreme Conditions'", "Arrangements during T8+, black rainstorm and 'extreme conditions'."],
                 ])),
                ("src", T("📖 完整守則清單及免費下載(官方):[勞工處「乙部:工作守則」](https://www.labour.gov.hk/tc/public/content2_8b.htm)。",
                          "📖 Full official list and free downloads: [LD “Part B: Codes of Practice”](https://www.labour.gov.hk/tc/public/content2_8b.htm).")),
            ],
        },
        {
            "h": T("相關刊物", "Related publications"),
            "blocks": [
                ("p", T("勞工處亦出版大量指引及小冊子(屬建議性質),並設季度《職業安全及健康訓練課程手冊》;職安局另有豐富教材。",
                        "LD also publishes guidance booklets (advisory) and a quarterly OSH training courses handbook; OSHC provides extensive materials.")),
                ("src", T("來源:[勞工處出版物](https://www.labour.gov.hk/tc/public/content2_8b.htm)｜[職安局 OSHC](https://www.oshc.org.hk)。",
                          "Sources: [LD publications](https://www.labour.gov.hk/tc/public/content2_8b.htm)｜[OSHC](https://www.oshc.org.hk).")),
            ],
        },
    ],
}
