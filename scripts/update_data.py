...
SOURCES = [
    ...
    {"id": "news_ticker", "region": "HK", "label": "香港政府新聞網·新聞速遞(即時)",
     "method": "rss", "url": "https://www.news.gov.hk/tc/common/html/ticker.rss.xml",
     "home": "https://www.news.gov.hk", "filter": True, "cap": 15},
    ...
    {"id": "osha", "region": "INTL", "label": "美國職業安全健康局(OSHA)",
     "method": "rss", "url": "https://www.osha.gov/news/newsreleases.xml",
     "home": "https://www.osha.gov", "filter": False, "cap": 15},
    {"id": "osha_qt", "region": "INTL", "label": "OSHA QuickTakes 通訊",
     "method": "rss", "url": "https://www.osha.gov/sites/default/files/quicktakes.xml",
     "home": "https://www.osha.gov/quicktakes", "filter": False, "cap": 8},
